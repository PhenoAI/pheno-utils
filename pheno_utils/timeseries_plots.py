...
# %% auto 0
__all__ = ['TIME_FORMAT', 'DEFAULT_CMAP', 'TimeSeriesFigure', 'format_xticks', 'filter_df', 'plot_events_bars',
           'plot_events_fill', 'prepare_events']
...
def filter_df(
    ...
    Args:
        ...
        date_range: The date range to filter by. Can be a tuple of two dates / times or two strings.
...
# %% ../nbs/15_timeseries_plots.ipynb 6
...
def prepare_events(
    ...
    """
    events = filter_df(events, participant_id, array_index, date_range, x_start, x_end)
